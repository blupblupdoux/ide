...
class Patient
{
    ...
    public function setAddressInfo(?string $address_info): self
    {
    ...
    public function getSecuNb(): ?string
    {
        return $this->secu_nb;
    }

    public function setSecuNb(?string $secu_nb): self
    {
        $this->secu_nb = $secu_nb;
